...
def hashtable_find_entry(htable, key):
...
#     bucket.append([key, value])
    if hashtable_find_entry(htable, key) != None:
       hashtable_find_entry(htable, key)[1] = value
    else:
...
#     return None
    if hashtable_find_entry(htable, key) != None:
       return hashtable_find_entry(htable, key)[1]
    else:
       return None
